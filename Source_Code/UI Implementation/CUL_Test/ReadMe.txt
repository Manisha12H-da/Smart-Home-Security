================================================================================
 MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: CUL_Test-Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese CUL_Test-Anwendung für Sie 
...
finden, aus denen Ihre CUL_Test–Anwendung besteht.
...
CUL_Test.h
    ...
    die CCUL_TestApp-Anwendungsklasse.

CUL_Test.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CCUL_TestApp-
...
res\CUL_Test.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "CUL_Test.rc" 
    enthalten.
...
CUL_TestDlg.h, CUL_TestDlg.cpp – das Dialogfeld
    Diese Dateien enthalten Ihre CCUL_TestDlg–Klasse. Diese Klasse 
    bestimmt das Verhalten des Hauptdialogfelds Ihrer Anwendung. Die Vorlage des 
    Dialogfelds befindet sich in der Datei "CUL_Test.rc", die in 
...
"StdAfx.h", "StdAfx.cpp"
    ...
    (PCH-Datei) mit dem Namen "CUL_Test.pch.pch2 und eine 
